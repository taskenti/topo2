...
1.
Escriba el código oficial del sendero (ejemplo: PR-GU 08)
2.
Introduzca el nombre completo de la ruta
3.
Seleccione el tipo de recorrido (Circular, Lineal, Travesía, Ida y Vuelta)
4.
Redacte los cuatro párrafos descriptivos siguiendo las indicaciones de ayuda
...
1.
Verá un mensaje de confirmación con los datos de la ruta
2.
Descargue el archivo PDF mediante el botón de descarga
3.
El archivo se nombrará automáticamente con el código de la ruta
...
1.
Añada el campo en la función correspondiente de app.py
2.
Incluya el dato en el diccionario pdf_data de la función generate_pdf
3.
Añada la lógica de dibujo en pdf_generator.py siguiendo el patrón existente
